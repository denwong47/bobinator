 ...
 ?P5PJ.            .JP5PJ    JP?               .YP7    J~                .J:
  !5PP5?^.      .^?5PP5!      !55!.          .7P5^      !7:            .!7.
   .75PPPP5YJJY5PPPP57.        .~Y5Y?!^^^~!?55J^          ^!~^:.....:~!~.
    ...
    pub static ref PROMPT_FOR_COMMAND: String = String::from("Enter Command: ");

    pub static ref PROMPT_FOR_API_TOKEN: String = String::from("Either login, or fetch the API token yourself.");
}
